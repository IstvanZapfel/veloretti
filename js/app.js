(() => {
    ...
    function initSliders() {
        if (document.querySelector(".product-cards__slider")) {
            new swiper_core_Swiper(".product-cards__slider", {
            ...
            let paginationImages = document.querySelectorAll(".pagination-image");
            let sliderDotts = document.querySelectorAll(".swiper-pagination .swiper-pagination-bullet");
            for (let index = 0; index < paginationImages.length; index++) {
                const paginationImage = paginationImages[index].querySelector("img").getAttribute("src");
                sliderDotts[index].style.backgroundImage = "url('" + paginationImage + "')";
            }
        }
        if (document.querySelector(".explore-cards__slider")) new swiper_core_Swiper(".explore-cards__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
